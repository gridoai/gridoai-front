...
export default {
  gaiaLandingPage: {
    hero: {
      ...
      callToAction: `Adicionar ao WhatsApp`,
      secondaryCallToAction: `Saiba Mais`,
      demoImgAlt: `Gaia, a Assistente de IA`,
    },
    features: {
    ...
    cta: {
      ...
      buttonText: `Conversar com a Gaia`,
    },
    layout: {
  ...
  upload: {
    ...
    started: `Upload em andamento, você será notificado quando terminar`,
  },
